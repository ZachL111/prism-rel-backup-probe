...
`prism-rel-backup-probe` is centered on reliability work in Solidity. The technical target is: Develop a Solidity command-oriented project for backup scenarios with negative fixtures, human-readable error snapshots, and fixture-scale datasets.
...
The score is deterministic. The current threshold is 160. Risk has a penalty of 7, latency has a penalty of 2, and weight contributes a bonus of 3.
