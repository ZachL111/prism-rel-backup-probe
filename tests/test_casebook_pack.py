"""Regression checks for the prism-rel-backup-probe casebook."""
...
from casebook.harness import assert_expected, prism_rel_backup_probe_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(prism_rel_backup_probe_summary(), assert_expected())
